...
var DiagramData_1 = require("./DiagramData");
var LocationData_1 = require("./LocationData");
...
var DiagramComponent = (function () {
    ...
    function DiagramComponent(inspector, notesInspector, searchService, areaService, aspectRatio, _authenticator) {
        var _this = this;
        ...
        this.myEvent1 = new core_1.EventEmitter();
        this.showPaletteEvent = new core_1.EventEmitter();
        this.showArea = new core_1.EventEmitter();
        this.notesInspector = notesInspector;
        inspector.createDiagramEvent$.subscribe(function (res) {
            //      areaService.showEnterprisePane$.next(10);
            areaService.displayDiagram$.next(10);
            areaService.displayDiagramTree$.next(10);
            _this.DisplayDiagram(res);
        });
        searchService.createDiagram$
            ...
            _this.TabCreateForArea(guid, Name);
        ...
        searchService.createDiagramWithLocation$
            ...
            var groupNode = _this.diagrams.findNodeForKey(locationId);
            _this.diagrams.position = groupNode.part.actualBounds.position;
        }, function (err) { return console.log(err); }, function () { return console.log("Created diagram obserable completed"); });
    }
    ...
    DiagramComponent.prototype.DisplayDiagram = function (GUID) {
        //    this.guid = GUID;
        var self = this;
    ...
    DiagramComponent.prototype.CreateDiagram = function () {
        var _this = this;
        ...
        var myDiagram = GO(go.Diagram, diagramDiv, {
            ...
            "relinkingTool.fromHandleArchetype": GO(go.Shape, "Circle", {
                segmentIndex: 0, cursor: "pointer", desiredSize: new go.Size(8, 8),
                fill: "deepskyblue", stroke: "black"
            }),
            "relinkingTool.toHandleArchetype": GO(go.Shape, "Circle", {
                segmentIndex: -1, cursor: "pointer", desiredSize: new go.Size(8, 8),
                fill: "deepskyblue", stroke: "black"
            }),
            "linkReshapingTool.handleArchetype": GO(go.Shape, "Square", {
                desiredSize: new go.Size(7, 7),
        ...
        var myTreeView = GO(go.Diagram, "LocationTree", {
            allowMove: false,
            allowCopy: true,
        ...
        myDiagram.nodeTemplate =
            ...
            }, new go.Binding("location", "loc", go.Point.parse).makeTwoWay(go.Point.stringify), { contextMenu: GO(go.Adornment) }, GO(go.Shape, { fill: "white", stroke: "black", strokeWidth: 2 }, new go.Binding("stroke", "color"), new go.Binding("fill", "dColor"), new go.Binding("width", "width"), new go.Binding("height", "height"), new go.Binding("geometryString", "name", self.geoFunc), {
                portId: "", cursor: "pointer", fromLinkable: true, fromLinkableSelfNode: true, fromLinkableDuplicates: true,
                toLinkable: true, toLinkableSelfNode: true, toLinkableDuplicates: true
            }), GO(go.TextBlock, { margin: 5, text: "" }), this.makePort("T", go.Spot.Top, true, true), this.makePort("L", go.Spot.Left, true, true), this.makePort("R", go.Spot.Right, true, true), this.makePort("B", go.Spot.Bottom, true, false), {
        ...
        var linkSelectionAdornmentTemplate = GO(go.Adornment, "Link", GO(go.Shape, { isPanelMain: true, strokeWidth: 0 }, new go.Binding("stroke", "", function (v) { return "green"; })));
        myDiagram.linkTemplate =
            GO(go.Link, {
            ...
            }, { reshapable: true }, { toShortLength: 3, relinkableFrom: true, relinkableTo: true }, {
                ...
                mouseDrop: function (e, link) {
                    ...
                    model.addLinkData({ from: selnode.data.uuid, to: tnode.data.uuid });
                    console.log(model.toJson());
                    model.commitTransaction("reconnect link");
                }
            }, 
            // allow the user to relink existing links
            GO(go.Shape, { name: "LSHAPE", strokeWidth: 4 }, new go.Binding("stroke", "", function (v) { return "black"; })), GO("Shape", { name: "LARROW", strokeWidth: 3, toArrow: "Standard" }, new go.Binding("stroke", "", function (v) { return "black"; })), {
                contextMenu: GO(go.Adornment, "Vertical", GO("ContextMenuButton", GO(go.TextBlock, "Reverse"), {
        ...
        myDiagram.groupTemplate =
            GO(go.Group, "Vertical", new go.Binding("location", "loc", go.Point.parse).makeTwoWay(go.Point.stringify), {
            ...
            }, new go.Binding("text", "name").makeTwoWay(), new go.Binding("stroke", "color")), GO(go.Panel, "Auto", { name: "PANEL" }, GO(go.Shape, "Rectangle", // the rectangular shape around the members
            { fill: "white", stroke: "gray", strokeWidth: 3 }), GO(go.Placeholder, { padding: 10 })));
        ...
        myTreeView.nodeTemplate =
            ...
            }), GO(go.Panel, "Horizontal", { position: new go.Point(16, 0) }, new go.Binding("background", "isSelected", function (s) { return (s ? "lightblue" : "black"); }).ofObject(), GO(go.Picture, {
                width: 18, height: 18,
                margin: new go.Margin(0, 4, 0, 0),
                imageStretch: go.GraphObject.Uniform
            }), GO(go.TextBlock, { editable: true, stroke: "white" }, new go.Binding("text", "name").makeTwoWay())) // end Horizontal Panel
            ); // end Node
        // without lines
        ...
        this.inspector.CreateOrInsertDiagramJson(diagramData, this._authenticator.TenantName)
            ...
            _this.inspector.tenantId = _this.diagramData.tenantId;
            self.diagrams.model.nodeDataArray = go.Model.fromJson(_this.diagramData.diagramJson).nodeDataArray;
            self.diagrams.model.linkDataArray = go.Model.fromJson(_this.diagramData.diagramJson).linkDataArray;
            //                self.diagrams.model = go.Model.fromJson(res).nodeDataArray;
            _this.myTreeView.model.nodeDataArray = myDiagram.model.nodeDataArray;
        });
    ...
    DiagramComponent.prototype.ListenToEvent = function (myDiagram) {
        var self = this;
        ...
        myDiagram.addDiagramListener("ObjectSingleClicked", function (e) {
            ...
            while (selectedparts.next()) {
                ...
                //For Info Pane.
                self.inspector.getInfoPaneObservable.next(JSON.stringify({
        ...
        myDiagram.addDiagramListener("ExternalObjectsDropped", function (e) {
            ...
            if (!isGroup) {
                ...
                while (selected.next()) {
                    ...
                    var loc = new LocationData_1.LocationData();
    ...
    DiagramComponent.prototype.TabCreateForArea = function (GUID, locationName) {
        var self = this;
    ...
    DiagramComponent.prototype.addTab1 = function (GUID, locationName) {
    ...
    DiagramComponent.prototype.geoFunc = function (geoname) {
        if (icons_1.IconsComponent.icons[geoname])
            return icons_1.IconsComponent.icons[geoname];
        else
            return icons_1.IconsComponent.icons["screwPump"];
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', go.Diagram)
    ], DiagramComponent.prototype, "areaDiagrams", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', go.Diagram)
    ], DiagramComponent.prototype, "areaTreeDiagram", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', go.Diagram)
    ], DiagramComponent.prototype, "diagrams", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', go.Diagram)
    ], DiagramComponent.prototype, "diagramTree", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', go.Diagram)
    ], DiagramComponent.prototype, "peopleDiagram", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', go.Diagram)
    ], DiagramComponent.prototype, "peopleTreeDiagram", void 0);
    __decorate([
    ...
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], DiagramComponent.prototype, "myEvent", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], DiagramComponent.prototype, "myEvent1", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], DiagramComponent.prototype, "showPaletteEvent", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], DiagramComponent.prototype, "showArea", void 0);
    DiagramComponent = __decorate([
        ...
        __metadata('design:paramtypes', [diagramService_1.DiagramService, notesService_1.NotesService, searchService_1.SearchService, areaService_1.AreaService, AspectRatioService_1.AspectRatioService, Authenticator_1.Authenticator])
    ], DiagramComponent);
